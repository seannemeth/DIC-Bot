import { ActionRowBuilder, ButtonBuilder, ButtonStyle, EmbedBuilder, SlashCommandBuilder, TextChannel, ChannelType } from 'discord.js';
...
export const command = {
  ...
  async execute(interaction: any) {
    ...
    const game = await prisma.game.create({ data: {
      ...
      homeTeam: me.team, awayTeam: opp.team,
      homePts: myPts, awayPts: oppPts,
      status: 'pending', reportedById: me.id
    }});
...
// Button handlers live in index.ts
